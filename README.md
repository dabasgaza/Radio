...
# | \*\*SQL Server\*\* | قاعدة بيانات علائقية مع دعم كامل للترتيب العربي `Arabic\_CI\_AS`. |
...
# 1\.  \*\*قاعدة البيانات:\*\* قم بتنفيذ سكريبت SQL الموجود في مجلد `/Database/Final\_Schema.sql`.
...
# \*تم تطوير هذا النظام ليكون معياراً في إدارة المؤسسات الإعلامية الصغيرة والمتوسطة.\*
